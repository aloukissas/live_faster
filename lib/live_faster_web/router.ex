defmodule LiveFasterWeb.Router do
  use LiveFasterWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LiveFasterWeb.Layouts, :root}
  ...
  # scope "/api", LiveFasterWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:live_faster, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LiveFasterWeb.Telemetry
